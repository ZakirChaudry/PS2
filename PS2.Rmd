...
Education <- sample(Education_Values, Eligible_Voters, replace = TRUE, prob = c( ))
Sexual_Preferences <- sample(Sexual_Preference_Values, Eligible_Voters, replace = TRUE)
Income <- sample(Income_Values, Eligible_Voters, replace = TRUE, prob = c())
Voting <- sample(Voting_Values, Eligible_Voters, replace = TRUE)
...
Party_Voting <- sample(Party_Values, Eligible_Voters, replace = TRUE)
Party_Prev <- sample(Party_Values, Eligible_Voters, replace = TRUE)
